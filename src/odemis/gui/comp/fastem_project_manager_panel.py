...
from odemis.gui.model import TOOL_ELLIPSE, TOOL_NONE, TOOL_POLYGON, TOOL_RECTANGLE, TOOL_GROUP, TOOL_UNGROUP
...
class FastEMProjectManagerPanel:
    ...
    def _enable_tools(self, enable):
        ...
        self.toolbar.enable_button(TOOL_GROUP, enable)
        self.toolbar.enable_button(TOOL_UNGROUP, enable)
